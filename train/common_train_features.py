...
def train_and_save(model, trained_model_folder, x, y, epochs, batch_size, validation_split):
    ...
    model.fit(
        ...
        callbacks=[ModelCheckpoint(
            '{}/batch={}-epoch={{epoch:d}}-val_loss={{val_loss:f}}.h5'.format(trained_model_folder, unix_time))]
    )
