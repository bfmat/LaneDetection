...
def process_single_image(image, inference_engines, steering_engine, marker_radius):
    ...
    # Return relevant metadata about the image
    return center_x, error, steering_angle
...
def process_images(image_folder, inference_engines, steering_engine, marker_radius):
    ...
    for image_name in image_names:
        ...
        image_data = process_single_image(image, inference_engines, steering_engine, marker_radius)
